...
function SimulationResult({ result, onAgain, onClose, onReflectionSaved }: { result: SimulationRecord; onAgain: () => void; onClose: () => void; onReflectionSaved: (reflection: NonNullable<SimulationRecord["reflection"]>) => void }) {
