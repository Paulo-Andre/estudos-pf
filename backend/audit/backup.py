...
from study.models import CompletedModule,SimulationRecord,StudyAnswer,StudyBookmark,StudyContentProgress,StudyNote,StudyProfile,StudyReviewItem,StudyRoadmapItem
...
MODELS=[
 AccountProfile,AccountPreferences,Course,CourseEnrollment,StudyProfile,CompletedModule,StudyAnswer,SimulationRecord,StudyNote,StudyReviewItem,StudyContentProgress,StudyRoadmapItem,StudyBookmark,
