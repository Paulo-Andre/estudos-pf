...
from .views import AdminContentDetailView,AdminContentsView,AdminDisciplineDetailView,AdminDisciplinesView,AdminQuestionDetailView,AdminQuestionImportView,AdminQuestionsView,AdminContentImportView,AdminImportTemplateView,AdminReviewDecisionView,AdminReviewPendingCountView,AdminReviewQueueView,AdminReviewSubmitView,ContentChangelogView,CourseLibraryView,CourseStudyBundleView,EligibleQuestionsView,QuestionChangelogView
...
urlpatterns=[
    ...
    path("admin/import/contents/",AdminContentImportView.as_view()),
    path("admin/import/templates/<str:kind>/",AdminImportTemplateView.as_view()),
    ...
    path("admin/import/questions/",AdminQuestionImportView.as_view()),
