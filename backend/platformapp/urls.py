...
from .views import AdminAlertsView,AdminCompetitionClearView,AdminCompetitionSaveView,AdminCompetitionSettingsView,AdminSettingsView,AdminImageUploadView,AlertDismissView,AlertListView,CompetitionAnswerView,CompetitionCoursesView,CompetitionHistoryView,CompetitionMonthlyGoalView,CompetitionMyScoreView,CompetitionRankingView,CompetitionRoundView,CompetitionSettingsView,CompetitionStartView,PublicSettingsView
urlpatterns=[
