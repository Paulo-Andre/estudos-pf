...
from .views import AdminAlertsView,AdminCompetitionSettingsView,AdminSettingsView,AlertDismissView,AlertListView,CompetitionAnswerView,CompetitionRankingView,CompetitionStartView,PublicSettingsView
urlpatterns=[
