...
from .views import AdminApproveOrderView,AdminCancelOrderView,AdminCommerceMetricsView,AdminCouponDetailView,AdminCouponsView,AdminOrdersView,AdminPlanDetailView,AdminPlansView,CheckoutOrderView,CheckoutView,CreateOrderView,MercadoPagoWebhookView,MyAccessesView,MyOrdersView,PublicPlansView
urlpatterns=[
 path("plans/",PublicPlansView.as_view()),
 path("orders/",MyOrdersView.as_view()),
 path("accesses/",MyAccessesView.as_view()),
 path("orders/create/",CreateOrderView.as_view()),
 path("orders/<str:order_id>/checkout/",CheckoutOrderView.as_view()),
